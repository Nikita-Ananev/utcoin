...
private class PopUpWindowView: UIView {
    ...
    init() {
        ...
        // Popup Background
        popupView.backgroundColor = UIColor.colorFromHex("fbf4fc")
        ...
        popupTitle.backgroundColor = UIColor.colorFromHex("c9e0f1")
        ...
        popupButton.backgroundColor = UIColor.colorFromHex("69e880")
